...
function find_subtitles()
	...
	local ss = os.capture("subliminal download --provider opensubtitles --provider podnapisi --provider thesubdb --provider tvsubtitles -l fr -v '" .. mp.get_property("path") .. "'")
...
mp.add_key_binding("g", "subtitles", find_subtitles)
