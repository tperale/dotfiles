...
do
  local _base_0 = {
    ...
    removeSubscriber = function(self, index)
      for i = index + 1, self.subscriberCount do
        self.subscribers[i].aggregatorIndex = self.subscribers[i].aggregatorIndex - 1
      end
  ...
  local _class_0 = setmetatable({
    __init = function(self)
      ...
      mp.register_event('seek', (function()
        local _base_1 = self
        local _fn_0 = _base_1.forceUpdate
        return function(...)
          return _fn_0(_base_1, ...)
        end
      end)())
  ...
  local _class_0 = setmetatable({
    __init = function(self, animationQueue)
      ...
      self.line = {
        ...
        [[-100,0]],
        [[)\3c&H262626&\c&HFFFFFF&\an2\alpha&H]],
        [[FF]],
        [[&}]],
        0
      }
  ...
  local _class_0 = setmetatable({
    __init = function(self, animationQueue)
      ...
      self.line = {
        ...
        [[4,-40]],
        [[)\3c&H262626&\c&HFFFFFF&}]],
        0
      }
      self.topBox = Rect(0, 0, 0, hover_zone * bar_height)
      self.animation = Animation(-40, 0, 0.25, (function()
        local _base_1 = self
        local _fn_0 = _base_1.animatePos
        return function(...)
          return _fn_0(_base_1, ...)
...
initDraw = function()
  ...
  return playlist:updatePlaylistInfo()
end
local fileLoaded
fileLoaded = function()
